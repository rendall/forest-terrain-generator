...
- [x] [docs] `RGB-DOC-01` Update user-facing docs to note replay-grid bounds fail-fast behavior for debug replay / hydrology-inspector recompute in [`README.md`](/mnt/c/workspace/projects/forest-terrain-generator/README.md).
