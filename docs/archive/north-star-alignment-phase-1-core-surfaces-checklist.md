...
Archived note: this checklist is complete and retained for historical traceability.
...
| ~~[ ]~~ | ~~NS1-README-04~~ | ~~Large hydrology schema + field contract details embedded in README.~~ | ~~`README.md:139-166`~~ | ~~You decided detailed schema contracts should live in specialized docs, not README.~~ | ~~Replace with concise conceptual hydrology-layer summary plus link to `docs/normative/water-depth-model.md`.~~ |
