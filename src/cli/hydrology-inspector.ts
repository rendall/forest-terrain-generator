...
import { runHydrologyInspectorTrace, writeHydrologyInspectorOverlayPpm } from "../app/run-hydrology-inspector.js";
...
program
	...
	.description("Inspect hydrology path/routing from a source tile")
